...
Read more: https://nextjs.org/docs/messages/invalid-use-server-value`),"__NEXT_ERROR_CODE",{value:"E352",enumerable:!1,configurable:!0})}}Object.defineProperty(c,"__esModule",{value:!0}),Object.defineProperty(c,"ensureServerEntryExports",{enumerable:!0,get:function(){return d}})},6846,a=>{"use strict";var b=a.i(5246),c=a.i(12259);let d=new Set(["password","password_hash","token","cookie","cookies","authorization","auth","secret"]),e=null,f=new Map;function g(a,b=500){return a.length<=b?a:`${a.slice(0,b)}...`}function h(a){return null==a?null:"string"==typeof a?g(a):"number"==typeof a||"boolean"==typeof a?a:Array.isArray(a)?a.slice(0,25).map(h):"object"==typeof a?Object.fromEntries(Object.entries(a).filter(([a])=>!d.has(a.toLowerCase())).slice(0,50).map(([a,b])=>[a,h(b)])):String(a)}function i(a){return a?{id:a.id,name:a.full_name,email:a.email,roles:a.roles}:null}async function j(){try{let a=await (0,b.headers)(),c=a.get("x-forwarded-for");return{ipAddress:a.get("cf-connecting-ip")??(c?c.split(",")[0]?.trim():null)??null,userAgent:a.get("user-agent")}}catch{return{ipAddress:null,userAgent:null}}}async function k(){e||(e=(async()=>{await (0,c.execute)(`
  ...
  `,[a?.id??0])).sort((a,b)=>a.nama_kelas.localeCompare(b.nama_kelas,void 0,{numeric:!0,sensitivity:"base"}))}async function h(){return(0,e.getCachedMarhalahList)()}async function i(a){let b=await (0,f.getWeeklyGuruRules)(a.map(a=>a.id)),c=(0,f.buildWeeklyGuruRuleMap)(b);return a.map(a=>{let b=(0,f.summarizeWeeklyGuruAssignments)(a,c);return{...a,guru_shubuh:b.shubuh,guru_ashar:b.ashar,guru_maghrib:b.maghrib}})}async function j(a){let b=await (0,d.queryOne)(`
    ...
    WHERE k.id = ?
  `,[a]);if(!b)return{error:"Kelas tidak ditemukan"};let[c]=await i([b]);return{kelas:c,santriList:await (0,d.query)(`
  ...
  `,[a])}}async function k(a){let b=await (0,e.getCachedTahunAjaranAktif)(),c=(await (0,d.query)(`
    SELECT
      k.id,
      k.nama_kelas,
      m.nama AS marhalah_nama,
  ...
  `,[a,b?.id??0])).sort((a,b)=>a.nama_kelas.localeCompare(b.nama_kelas,void 0,{numeric:!0,sensitivity:"base"}));if(!c.length)return{error:"Tidak ada kelas di tingkat ini."};let f=await i(c);return{massal:await Promise.all(f.map(async a=>{let b=await (0,d.query)(`
      SELECT s.id, s.nama_lengkap, s.nis, s.asrama, s.kamar, s.sekolah, s.kelas_sekolah, s.jenis_kelamin
      FROM riwayat_pendidikan rp
      JOIN santri s ON s.id = rp.santri_id
      WHERE rp.kelas_id = ? AND rp.status_riwayat = 'aktif' AND s.status_global = 'aktif'
      ORDER BY s.nama_lengkap
    `,[a.id]);return{kelas:a,santriList:b}}))}}(0,a.i(13095).ensureServerEntryExports)([g,h,j,k]),(0,c.registerServerReference)(g,"00a13022635b2e13e723fb96e05211e5f81128f34d",null),(0,c.registerServerReference)(h,"002921fbb41de8ddfcf4d3e637d290d148c7603fd6",null),(0,c.registerServerReference)(j,"40c74fe7552a4dfc3d1514dc9d577b5495035449f3",null),(0,c.registerServerReference)(k,"408220b9b110e334b8f164735716ecfe7ff9486750",null),a.s([],37110),a.i(37110),a.s(["002921fbb41de8ddfcf4d3e637d290d148c7603fd6",()=>h,"003144417e19712e947907ca31b6b39c8aa99a63df",()=>b.signOut,"00a13022635b2e13e723fb96e05211e5f81128f34d",()=>g,"408220b9b110e334b8f164735716ecfe7ff9486750",()=>k,"40c74fe7552a4dfc3d1514dc9d577b5495035449f3",()=>j],92856)}];

//# sourceMappingURL=_ed6a678b._.js.map