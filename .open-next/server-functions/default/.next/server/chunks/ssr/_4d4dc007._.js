...
Read more: https://nextjs.org/docs/messages/invalid-use-server-value`),"__NEXT_ERROR_CODE",{value:"E352",enumerable:!1,configurable:!0})}}Object.defineProperty(c,"__esModule",{value:!0}),Object.defineProperty(c,"ensureServerEntryExports",{enumerable:!0,get:function(){return d}})},6846,a=>{"use strict";var b=a.i(5246),c=a.i(12259);let d=new Set(["password","password_hash","token","cookie","cookies","authorization","auth","secret"]),e=null,f=new Map;function g(a,b=500){return a.length<=b?a:`${a.slice(0,b)}...`}function h(a){return null==a?null:"string"==typeof a?g(a):"number"==typeof a||"boolean"==typeof a?a:Array.isArray(a)?a.slice(0,25).map(h):"object"==typeof a?Object.fromEntries(Object.entries(a).filter(([a])=>!d.has(a.toLowerCase())).slice(0,50).map(([a,b])=>[a,h(b)])):String(a)}function i(a){return a?{id:a.id,name:a.full_name,email:a.email,roles:a.roles}:null}async function j(){try{let a=await (0,b.headers)(),c=a.get("x-forwarded-for");return{ipAddress:a.get("cf-connecting-ip")??(c?c.split(",")[0]?.trim():null)??null,userAgent:a.get("user-agent")}}catch{return{ipAddress:null,userAgent:null}}}async function k(){e||(e=(async()=>{await (0,c.execute)(`
    ...
    LIMIT 500
  `)).map(a=>{let b=new Date(`${a.tgl_selesai_datang}T23:59:59+07:00`);return{log_id:a.id,santri_id:a.santri_id,nama:a.nama_lengkap,info:`${a.asrama||"-"} / ${a.kamar||"-"}`,periode:a.nama_periode,batas_kembali:a.tgl_selesai_datang,status_label:"BELUM KEMBALI (Telat Perpulangan)",durasi_telat:(0,h.formatDistance)(b,new Date,{locale:i.id,addSuffix:!1}),alasan:a.keterangan||`Periode: ${a.nama_periode}`}})}async function k(a,b,c){let h=await (0,e.getSession)();if(!h)return{error:"Unauthorized"};if("MANGKIR"===c)return{success:!0,message:"Ditandai mangkir. Data tetap muncul di antrian."};"TELAT_MURNI"===c&&await (0,d.execute)(`
    ...
    `,[(0,d.generateId)(),b,(0,d.now)(),h.id]);let i="TELAT_MURNI"===c?"VONIS":"SUDAH";return await (0,d.execute)("UPDATE perpulangan_log SET status_datang = ?, tgl_datang = ?, updated_by = ? WHERE id = ?",[i,(0,d.now)(),h.id,a]),await (0,f.logActivity)({actor:(0,f.actorFromSession)(h),module:"asrama_perpulangan_verifikasi_telat",action:"approval",fiturHref:"/dashboard/asrama/perpulangan/verifikasi-telat",logKind:"update",entityType:"perpulangan_log",entityId:a,entityLabel:b,summary:`Memberi vonis telat perpulangan ${c.toLowerCase().replaceAll("_"," ")}`,details:{santri_id:b,vonis:c}}),(0,g.revalidatePath)("/dashboard/asrama/perpulangan"),(0,g.revalidatePath)("/dashboard/asrama/perpulangan/monitoring"),(0,g.revalidatePath)("/dashboard/asrama/perpulangan/verifikasi-telat"),(0,g.revalidatePath)("/dashboard/keamanan"),{success:!0}}(0,a.i(13095).ensureServerEntryExports)([j,k]),(0,c.registerServerReference)(j,"0043b5e3f8830f1702cf05d59059e3dffea7bfc34e",null),(0,c.registerServerReference)(k,"7040e2ae8b315a1f665c4ce072638a07a77e136d1e",null),a.s([],46271),a.i(46271),a.s(["003144417e19712e947907ca31b6b39c8aa99a63df",()=>b.signOut,"0043b5e3f8830f1702cf05d59059e3dffea7bfc34e",()=>j,"7040e2ae8b315a1f665c4ce072638a07a77e136d1e",()=>k],83254)}];

//# sourceMappingURL=_4d4dc007._.js.map