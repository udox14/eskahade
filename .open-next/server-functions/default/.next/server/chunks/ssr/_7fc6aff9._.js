...
Read more: https://nextjs.org/docs/messages/invalid-use-server-value`),"__NEXT_ERROR_CODE",{value:"E352",enumerable:!1,configurable:!0})}}Object.defineProperty(c,"__esModule",{value:!0}),Object.defineProperty(c,"ensureServerEntryExports",{enumerable:!0,get:function(){return d}})},24895,a=>{"use strict";var b=a.i(37936),c=a.i(53058);a.i(70396);var d=a.i(73727),e=a.i(18558);async function f(){await (0,c.clearSession)(),(0,e.revalidatePath)("/","layout"),(0,d.redirect)("/login")}(0,a.i(13095).ensureServerEntryExports)([f]),(0,b.registerServerReference)(f,"006f4c55239f4a20efcdddda1e3014433a5c909281",null),a.s(["signOut",()=>f])},13750,a=>{"use strict";var b=a.i(24895),c=a.i(37936),d=a.i(12259),e=a.i(53058);async function f(){let a=await (0,e.getSession)();if(!a)return{role:"guest",filter:null};let b=a.role;if((0,e.hasRole)(a,"pengurus_asrama"))return{role:b,type:"ASRAMA",value:a.asrama_binaan};if((0,e.hasRole)(a,"wali_kelas")){let c=await (0,d.queryOne)("SELECT id FROM kelas WHERE wali_kelas_id = ?",[a.id]);return{role:b,type:"KELAS",value:c?.id}}return{role:b,type:"GLOBAL",value:null}}async function g(a,b,c,e){let g=await f(),h=`
  ...
  `,[b.id]):[]}async function i(){return{kelas:(await (0,d.query)("SELECT id, nama_kelas FROM kelas")).sort((a,b)=>a.nama_kelas.localeCompare(b.nama_kelas,void 0,{numeric:!0,sensitivity:"base"}))}}(0,a.i(13095).ensureServerEntryExports)([f,g,h,i]),(0,c.registerServerReference)(f,"0063221242d792fff9b0db9a1fa9bfba159985c81b",null),(0,c.registerServerReference)(g,"781f5531b9af3a7dfc6e761c83ad0ed0a15a299e77",null),(0,c.registerServerReference)(h,"40fc7fd82263957ecf3bc3ef311d2f2c4de6e5d364",null),(0,c.registerServerReference)(i,"00fcc371045934b177919c6449e7c9683c078b35fd",null),a.s([],24719),a.i(24719),a.s(["0063221242d792fff9b0db9a1fa9bfba159985c81b",()=>f,"006f4c55239f4a20efcdddda1e3014433a5c909281",()=>b.signOut,"00fcc371045934b177919c6449e7c9683c078b35fd",()=>i,"40fc7fd82263957ecf3bc3ef311d2f2c4de6e5d364",()=>h,"781f5531b9af3a7dfc6e761c83ad0ed0a15a299e77",()=>g],13750)}];
