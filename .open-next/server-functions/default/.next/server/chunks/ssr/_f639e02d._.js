...
Read more: https://nextjs.org/docs/messages/invalid-use-server-value`),"__NEXT_ERROR_CODE",{value:"E352",enumerable:!1,configurable:!0})}}Object.defineProperty(c,"__esModule",{value:!0}),Object.defineProperty(c,"ensureServerEntryExports",{enumerable:!0,get:function(){return d}})},6846,a=>{"use strict";var b=a.i(5246),c=a.i(12259);let d=new Set(["password","password_hash","token","cookie","cookies","authorization","auth","secret"]),e=null,f=new Map;function g(a,b=500){return a.length<=b?a:`${a.slice(0,b)}...`}function h(a){return null==a?null:"string"==typeof a?g(a):"number"==typeof a||"boolean"==typeof a?a:Array.isArray(a)?a.slice(0,25).map(h):"object"==typeof a?Object.fromEntries(Object.entries(a).filter(([a])=>!d.has(a.toLowerCase())).slice(0,50).map(([a,b])=>[a,h(b)])):String(a)}function i(a){return a?{id:a.id,name:a.full_name,email:a.email,roles:a.roles}:null}async function j(){try{let a=await (0,b.headers)(),c=a.get("x-forwarded-for");return{ipAddress:a.get("cf-connecting-ip")??(c?c.split(",")[0]?.trim():null)??null,userAgent:a.get("user-agent")}}catch{return{ipAddress:null,userAgent:null}}}async function k(){e||(e=(async()=>{await (0,c.execute)(`
    ...
    `,[a])}async function j(a){let b=await (0,e.getSession)();if(!b)return{error:"Unauthorized"};try{let c=a.map(()=>"?").join(",");return await (0,d.execute)(`UPDATE ehb_absensi SET is_susulan_done = 1 WHERE id IN (${c})`,a),await (0,f.logActivity)({actor:(0,f.actorFromSession)(b),module:"ehb_susulan",action:"update",fiturHref:"/dashboard/ehb/susulan",logKind:"update",entityType:"ehb_susulan_batch",entityId:"mark-susulan-done",entityLabel:"Susulan EHB",summary:`Menandai ${a.length} susulan EHB selesai`,details:{total_absensi:a.length}}),(0,g.revalidatePath)("/dashboard/ehb/susulan"),{success:!0}}catch(a){return{error:a.message}}}(0,a.i(13095).ensureServerEntryExports)([h,i,j]),(0,c.registerServerReference)(h,"00dd82a95a809cc3cf5a6394984ad0724259ee723a",null),(0,c.registerServerReference)(i,"407987fbdd26377cd43085ac91fafa33fb60409eb4",null),(0,c.registerServerReference)(j,"40d94da8061a471ab54f9f47f0f878ddfa697dcb0c",null),a.s([],84122),a.i(84122),a.s(["003144417e19712e947907ca31b6b39c8aa99a63df",()=>b.signOut,"00dd82a95a809cc3cf5a6394984ad0724259ee723a",()=>h,"407987fbdd26377cd43085ac91fafa33fb60409eb4",()=>i,"40d94da8061a471ab54f9f47f0f878ddfa697dcb0c",()=>j],44267)}];

//# sourceMappingURL=_f639e02d._.js.map