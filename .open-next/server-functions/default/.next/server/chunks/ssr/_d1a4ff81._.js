...
Read more: https://nextjs.org/docs/messages/invalid-use-server-value`),"__NEXT_ERROR_CODE",{value:"E352",enumerable:!1,configurable:!0})}}Object.defineProperty(c,"__esModule",{value:!0}),Object.defineProperty(c,"ensureServerEntryExports",{enumerable:!0,get:function(){return d}})},24895,a=>{"use strict";var b=a.i(37936),c=a.i(53058);a.i(70396);var d=a.i(73727),e=a.i(18558);async function f(){await (0,c.clearSession)(),(0,e.revalidatePath)("/","layout"),(0,d.redirect)("/login")}(0,a.i(13095).ensureServerEntryExports)([f]),(0,b.registerServerReference)(f,"006f4c55239f4a20efcdddda1e3014433a5c909281",null),a.s(["signOut",()=>f])},82050,a=>{"use strict";var b=a.i(24895),c=a.i(37936),d=a.i(12259),e=a.i(53058),f=a.i(18558),g=a.i(13095);async function h(){let a=new Date;a.setMonth(a.getMonth()-3);let b=a.toISOString().slice(0,10),c=await (0,d.query)(`
...
Detail: ${h}`,poin:g,penindak_id:b?.id??null}),f))await (0,d.execute)(`UPDATE absensi_harian SET ${j(i.sesi)} = 'OK' WHERE id = ?`,[i.absen_id])}else if("BELUM"===g)for(let a of f)await (0,d.execute)(`UPDATE absensi_harian SET ${j(a.sesi)} = 'BELUM' WHERE id = ?`,[a.absen_id]);else{let a="SAKIT"===g?"S":"IZIN"===g?"I":"H";for(let b of f)await (0,d.execute)(`UPDATE absensi_harian SET ${function(a){if(!i.includes(a))throw Error(`Sesi tidak valid: ${a}`);return a}(b.sesi)} = ?, ${j(b.sesi)} = NULL WHERE id = ?`,[a,b.absen_id])}}for(let a of c)await (0,d.execute)(`
      ...
      VALUES (?, ?, ?, ?, ?, ?, ?)
    `,[a.id,a.santri_id,a.tanggal,a.jenis,a.deskripsi,a.poin,a.penindak_id]);return(0,f.revalidatePath)("/dashboard/akademik/absensi/verifikasi"),(0,f.revalidatePath)("/dashboard/keamanan"),{success:!0,count:a.length}}(0,g.ensureServerEntryExports)([h,k]),(0,c.registerServerReference)(h,"00b9c32d82c6b4db8a5831d09b3ca63396c37872e7",null),(0,c.registerServerReference)(k,"40bbc8d3a30a39f51a710f8428edc910d5ed69ea70",null),a.s([],83654),a.i(83654),a.s(["006f4c55239f4a20efcdddda1e3014433a5c909281",()=>b.signOut,"00b9c32d82c6b4db8a5831d09b3ca63396c37872e7",()=>h,"40bbc8d3a30a39f51a710f8428edc910d5ed69ea70",()=>k],82050)}];
