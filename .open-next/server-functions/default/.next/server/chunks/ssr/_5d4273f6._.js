...
Read more: https://nextjs.org/docs/messages/invalid-use-server-value`),"__NEXT_ERROR_CODE",{value:"E352",enumerable:!1,configurable:!0})}}Object.defineProperty(c,"__esModule",{value:!0}),Object.defineProperty(c,"ensureServerEntryExports",{enumerable:!0,get:function(){return d}})},24895,a=>{"use strict";var b=a.i(37936),c=a.i(53058);a.i(70396);var d=a.i(73727),e=a.i(18558);async function f(){await (0,c.clearSession)(),(0,e.revalidatePath)("/","layout"),(0,d.redirect)("/login")}(0,a.i(13095).ensureServerEntryExports)([f]),(0,b.registerServerReference)(f,"006f4c55239f4a20efcdddda1e3014433a5c909281",null),a.s(["signOut",()=>f])},52201,a=>{"use strict";var b=a.i(24895),c=a.i(37936),d=a.i(12259),e=a.i(53058),f=a.i(18558);async function g(a){return(0,d.query)(`SELECT s.id, s.nama_lengkap, s.nis, s.asrama, s.kamar,
  ...
  `,m=await (0,d.queryOne)(`SELECT COUNT(*) AS total FROM (${l}) t`,[...h,...h]),n=m?.total??0;return{rows:await (0,d.query)(`SELECT * FROM (${l}) t ORDER BY created_at DESC LIMIT ? OFFSET ?`,[...h,...h,30,(f-1)*30]),total:n,page:f,totalPages:Math.ceil(n/30)}}async function m(a,b){if("pernyataan"===b){let b=await (0,d.queryOne)(`SELECT sp.id, sp.tanggal, sp.pelanggaran_ids,
       ...
       LEFT JOIN riwayat_pendidikan rp ON rp.santri_id = s.id AND rp.status_riwayat = 'aktif'
       LEFT JOIN kelas k ON k.id = rp.kelas_id
       WHERE sp.id = ?`,[a]);return b?{tipe:"perjanjian",surat:b,pelanggaran:[]}:null}}async function n(a,b){let c=await (0,e.getSession)();return c&&(0,e.hasAnyRole)(c,["admin","keamanan","dewan_santri"])?(await (0,d.execute)(`DELETE FROM ${"pernyataan"===b?"surat_pernyataan":"surat_perjanjian"} WHERE id = ?`,[a]),(0,f.revalidatePath)("/dashboard/surat-santri"),{success:!0}):{error:"Akses ditolak"}}async function o(){return(await (0,d.query)("SELECT DISTINCT asrama FROM santri WHERE asrama IS NOT NULL ORDER BY asrama")).map(a=>a.asrama)}(0,a.i(13095).ensureServerEntryExports)([g,h,i,j,k,l,m,n,o]),(0,c.registerServerReference)(g,"40dd8a372d4b1a4f54e70d5158623966ecb79d74b8",null),(0,c.registerServerReference)(h,"40adeb440f4b2fbd42f122e4c0cc9b5231cfda1c8d",null),(0,c.registerServerReference)(i,"400e5a0853c69bda06c2713f7a13f5f210a3f6ff54",null),(0,c.registerServerReference)(j,"70d2d0d0a7b6e82745531b40678b4a76bcead726b1",null),(0,c.registerServerReference)(k,"78234c9e083131b4fa4eb41b048e38208b8712028d",null),(0,c.registerServerReference)(l,"40709316f582f471d8d332eeaba09de3e2966a7484",null),(0,c.registerServerReference)(m,"60ff3dbbff342d208a09018641e44aa762741d790d",null),(0,c.registerServerReference)(n,"60d0dfd6a93924902cdebeadf1d638f97464a77b1a",null),(0,c.registerServerReference)(o,"00f23d3ff382ad0314b8c4b911958b9fe9ca90f757",null),a.s([],72377),a.i(72377),a.s(["006f4c55239f4a20efcdddda1e3014433a5c909281",()=>b.signOut,"00f23d3ff382ad0314b8c4b911958b9fe9ca90f757",()=>o,"400e5a0853c69bda06c2713f7a13f5f210a3f6ff54",()=>i,"40709316f582f471d8d332eeaba09de3e2966a7484",()=>l,"40adeb440f4b2fbd42f122e4c0cc9b5231cfda1c8d",()=>h,"40dd8a372d4b1a4f54e70d5158623966ecb79d74b8",()=>g,"60d0dfd6a93924902cdebeadf1d638f97464a77b1a",()=>n,"60ff3dbbff342d208a09018641e44aa762741d790d",()=>m,"70d2d0d0a7b6e82745531b40678b4a76bcead726b1",()=>j,"78234c9e083131b4fa4eb41b048e38208b8712028d",()=>k],52201)}];
