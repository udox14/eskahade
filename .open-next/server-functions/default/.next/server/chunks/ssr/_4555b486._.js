...
Read more: https://nextjs.org/docs/messages/invalid-use-server-value`),"__NEXT_ERROR_CODE",{value:"E352",enumerable:!1,configurable:!0})}}Object.defineProperty(c,"__esModule",{value:!0}),Object.defineProperty(c,"ensureServerEntryExports",{enumerable:!0,get:function(){return d}})},6846,a=>{"use strict";var b=a.i(5246),c=a.i(12259);let d=new Set(["password","password_hash","token","cookie","cookies","authorization","auth","secret"]),e=null,f=new Map;function g(a,b=500){return a.length<=b?a:`${a.slice(0,b)}...`}function h(a){return null==a?null:"string"==typeof a?g(a):"number"==typeof a||"boolean"==typeof a?a:Array.isArray(a)?a.slice(0,25).map(h):"object"==typeof a?Object.fromEntries(Object.entries(a).filter(([a])=>!d.has(a.toLowerCase())).slice(0,50).map(([a,b])=>[a,h(b)])):String(a)}function i(a){return a?{id:a.id,name:a.full_name,email:a.email,roles:a.roles}:null}async function j(){try{let a=await (0,b.headers)(),c=a.get("x-forwarded-for");return{ipAddress:a.get("cf-connecting-ip")??(c?c.split(",")[0]?.trim():null)??null,userAgent:a.get("user-agent")}}catch{return{ipAddress:null,userAgent:null}}}async function k(){e||(e=(async()=>{await (0,c.execute)(`
  ...
  `),await (0,b.execute)("INSERT OR IGNORE INTO app_settings (key, value) VALUES (?, ?)",[e,g]),await (0,b.execute)("INSERT OR IGNORE INTO app_settings (key, value) VALUES (?, ?)",[f,String(3)])}async function k(){await j();let[a,c]=await Promise.all([(0,b.queryOne)("SELECT value FROM app_settings WHERE key = ?",[e]),(0,b.queryOne)("SELECT value FROM app_settings WHERE key = ?",[f])]);return{mulaiBerlaku:l(a?.value),durasiBulan:m(c?.value)}}function l(a){let b=String(a??"").trim();return/^\d{4}-\d{2}-\d{2}$/.test(b)?b:g}function m(a){let b=Number(a);return Number.isFinite(b)?Math.min(24,Math.max(1,Math.trunc(b))):3}a.s(["KATEGORI_SANTRI_DASAR",0,c,"KATEGORI_SANTRI_EFEKTIF",0,d,"SANTRI_BARU_DURASI_KEY",0,f,"SANTRI_BARU_MULAI_KEY",0,e,"getKategoriSantriEfektifSql",()=>i,"getSantriBaruSettings",()=>k,"normalizeDurasiBulan",()=>m,"normalizeKategoriSantriDasar",()=>h,"normalizeMulaiBerlaku",()=>l])},91669,a=>{"use strict";var b=a.i(37936),c=a.i(18558),d=a.i(6846),e=a.i(4552),f=a.i(12259),g=a.i(85972),h=a.i(13095);let i="/dashboard/pengaturan/santri-baru";async function j(){let a=await (0,e.assertFeature)(i);return"error"in a?a:(0,g.getSantriBaruSettings)()}async function k(a){let b=await (0,e.assertFeature)(i);if("error"in b)return b;let h=(0,g.normalizeMulaiBerlaku)(a.mulaiBerlaku),j=(0,g.normalizeDurasiBulan)(a.durasiBulan);return await (0,f.execute)(`INSERT INTO app_settings (key, value, updated_at)
     VALUES (?, ?, datetime('now'))
     ON CONFLICT(key) DO UPDATE SET value = excluded.value, updated_at = excluded.updated_at`,[g.SANTRI_BARU_MULAI_KEY,h]),await (0,f.execute)(`INSERT INTO app_settings (key, value, updated_at)
     VALUES (?, ?, datetime('now'))
     ON CONFLICT(key) DO UPDATE SET value = excluded.value, updated_at = excluded.updated_at`,[g.SANTRI_BARU_DURASI_KEY,String(j)]),await (0,d.logActivity)({actor:(0,d.actorFromSession)(b),module:"pengaturan_santri_baru",action:"update",fiturHref:i,logKind:"update",entityType:"app_setting",entityId:"santri_baru",entityLabel:"Pengaturan masa santri baru",summary:"Memperbarui pengaturan masa santri baru",details:{mulai_berlaku:h,durasi_bulan:j}}),(0,c.revalidatePath)("/dashboard/santri"),(0,c.revalidatePath)("/dashboard/asrama/kamar"),(0,c.revalidatePath)("/dashboard/asrama/plotting-kamar-manual"),(0,c.revalidatePath)(i),{success:!0,mulaiBerlaku:h,durasiBulan:j}}(0,h.ensureServerEntryExports)([j,k]),(0,b.registerServerReference)(j,"00d86c562ded3ebd491ef2449c7c9ac61c0f61c2d5",null),(0,b.registerServerReference)(k,"406088b55425f89827408fb109543013f9caca6abe",null),a.s(["getPengaturanSantriBaru",()=>j,"simpanPengaturanSantriBaru",()=>k])},8453,a=>{"use strict";var b=a.i(24895),c=a.i(91669);a.s([],414),a.i(414),a.s(["003144417e19712e947907ca31b6b39c8aa99a63df",()=>b.signOut,"00d86c562ded3ebd491ef2449c7c9ac61c0f61c2d5",()=>c.getPengaturanSantriBaru,"406088b55425f89827408fb109543013f9caca6abe",()=>c.simpanPengaturanSantriBaru],8453)}];

//# sourceMappingURL=_4555b486._.js.map