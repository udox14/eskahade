...
function renderGroupIcon(group: string) {
  switch (group) {
    case 'Data Santri':
      return (
    ...
    case 'Kesantrian':
      return (
        <svg className="w-5.5 h-5.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round">
          <path d="M14 19c0-2.76-2.24-5-5-5H6c-2.76 0-5 2.24-5 5v2h13v-2z" />
          <circle cx="7.5" cy="6.5" r="3.5" fill="currentColor" fillOpacity={0.15} />
          <path d="M17 11l2 2 4-4" strokeWidth={2.3} />
        </svg>
      )
    case 'Asrama':
      return (
        <svg className="w-5.5 h-5.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round">
          ...
          <polyline points="9 22 9 12 15 12 15 22" fill="currentColor" fillOpacity={0.15} />
        </svg>
      )
    case 'Perizinan & Disiplin':
      return (
        <svg className="w-5.5 h-5.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round">
          <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" fill="currentColor" fillOpacity={0.15} />
          <line x1="12" y1="8" x2="12" y2="12" />
          <line x1="12" y1="16" x2="12.01" y2="16" strokeWidth={2.3} />
        </svg>
      )
    case 'Akademik':
    case 'Pengkelasan':
    ...
    case 'Nilai & Rapor':
      return (
        <svg className="w-5.5 h-5.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round">
          <rect x="3" y="3" width="18" height="18" rx="2" ry="2" fill="currentColor" fillOpacity={0.15} />
          <line x1="9" y1="9" x2="15" y2="9" />
          <line x1="9" y1="13" x2="15" y2="13" />
          <line x1="9" y1="17" x2="13" y2="17" />
        </svg>
      )
    case 'Absensi Akademik':
    case 'Absensi':
      return (
        <svg className="w-5.5 h-5.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round">
    ...
    case 'Keuangan':
      return (
        <svg className="w-5.5 h-5.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round">
          ...
          <path d="M4 6v12a2 2 0 0 0 2 2h14v-4" fill="currentColor" fillOpacity={0.15} />
          <path d="M18 12a2 2 0 0 0-2 2v2a2 2 0 0 0 2 2h4v-6z" />
        </svg>
      )
    case 'Keuangan Santri':
    case 'Operasional':
      return (
        <svg className="w-5.5 h-5.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round">
          <circle cx="8" cy="8" r="5" fill="currentColor" fillOpacity={0.15} />
          <circle cx="16" cy="16" r="5" fill="currentColor" fillOpacity={0.15} />
          <path d="M12 8a5 5 0 0 1 5 5v3" />
    ...
    case 'UPK':
      return (
        <svg className="w-5.5 h-5.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round">
          ...
          <path d="M16 10a4 4 0 0 1-8 0" fill="currentColor" fillOpacity={0.15} />
        </svg>
      )
    case 'EHB':
      return (
    ...
    case 'PSB':
      return (
        <svg className="w-5.5 h-5.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round">
          ...
          <circle cx="8.5" cy="7" r="4" fill="currentColor" fillOpacity={0.15} />
    ...
    default:
      return (
        <svg className="w-5.5 h-5.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round">
          <ellipse cx="12" cy="5" rx="9" ry="3" fill="currentColor" fillOpacity={0.15} />
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="w-9 h-9 flex items-center justify-center shrink-0">
                        <FeatureIcon className={cn("w-6 h-6 transition-transform duration-200 group-hover:scale-110", theme.text)} strokeWidth={1.8} />
                      </div>
