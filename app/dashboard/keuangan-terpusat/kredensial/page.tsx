...
export default async function CredentialPage(){
  ...
  return <main className="space-y-4 sm:space-y-5">
    <FinancePageHeader title="Kredensial" description="Enrollment cepat, integrasi reader, dan penerbitan kartu QR santri." eyebrow={`Mode aktif: ${mode}`} meta="Saldo dan PIN tidak pernah menempel pada kartu"/>
    <FinanceNav/>
