  ...
  return (
    <div className="space-y-4 md:space-y-6 max-w-7xl mx-auto pb-24 md:pb-10">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3">
        <div>
          <h1 className="text-2xl font-bold text-slate-800">Tes Klasifikasi</h1>
          <p className="text-slate-500 text-sm">Penentuan marhalah awal santri baru.</p>
        </div>
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <div className="relative flex-1 shadow-sm">
          ...
          <input 
            ...
            className="w-full pl-11 pr-4 py-3 md:py-2.5 border border-slate-300 rounded-xl focus:ring-2 focus:ring-green-500 outline-none text-sm md:text-base transition-all"
            value={search}
      ...
      {loading ? (
        ...
        <div className="text-center py-20 bg-white rounded-2xl border border-slate-100 shadow-sm text-slate-400 flex flex-col items-center justify-center">
          <CheckCircle className="w-12 h-12 text-slate-300 mb-3"/>
          <span className="text-lg font-bold text-slate-600 mb-1">Tidak ada santri baru.</span>
        ...
        <>
          ...
          <div className="grid grid-cols-1 gap-4 md:hidden">
            {dataSantri.map((s) => (
              <div key={s.id} className="bg-white rounded-2xl border border-slate-200 p-4 shadow-sm relative overflow-hidden">
                ...
                <div className="flex justify-between items-start pl-2 mb-3">
                  <div className="pr-2">
                    <h3 className="font-bold text-slate-900 text-base leading-tight">{s.nama}</h3>
                    <span className="text-xs font-medium text-slate-600 bg-slate-100 px-2 py-0.5 rounded mt-1 inline-block">
                  ...
                  <div className="shrink-0">
                    {s.status_tes === 'SUDAH' ? (
                      ...
                      <span className="flex items-center gap-1 bg-slate-100 text-slate-600 px-2.5 py-1 rounded-lg text-[10px] font-black uppercase tracking-wider">
                ...
                <button 
                  ...
                  className={`w-full py-3 rounded-xl text-sm font-bold flex items-center justify-center gap-2 transition-all active:scale-[0.98] ml-1 ${
                    s.status_tes === 'SUDAH' 
                      ...
                      : 'bg-blue-600 text-white shadow-sm hover:bg-blue-700 shadow-blue-600/20'
                  }`}
                >
          ...
          <div className="bg-white w-full h-full md:h-auto md:max-h-[90vh] md:max-w-2xl md:rounded-3xl flex flex-col shadow-2xl overflow-hidden animate-in slide-in-from-bottom-5 md:zoom-in-95">
            <form onSubmit={handleSimpan} className="flex flex-col h-full">
              ...
              <div className="p-4 md:p-6 border-t bg-white flex flex-col-reverse sm:flex-row justify-end gap-3 sticky bottom-0 z-20 shrink-0 shadow-[0_-10px_15px_-3px_rgba(0,0,0,0.05)] md:rounded-b-3xl">
                ...
                <button type="submit" disabled={saving} className="w-full sm:w-auto bg-green-600 text-white px-8 py-3.5 md:py-2.5 rounded-xl hover:bg-green-700 disabled:opacity-50 flex items-center justify-center gap-2 font-black shadow-sm shadow-green-600/20 transition-all active:scale-[0.98]">
