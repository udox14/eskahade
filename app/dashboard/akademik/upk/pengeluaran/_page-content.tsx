      ...
      <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-4 border-b pb-4">
        <div>
          <h1 className="text-2xl font-bold text-slate-800 flex items-center gap-2">
            <CreditCard className="w-6 h-6 text-red-600" /> Pengeluaran
          </h1>
          <p className="text-slate-500 text-sm">Catat kas keluar, bayar hutang toko, bayar pinjaman modal, dan royalti penulis.</p>
        </div>
