  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto pb-20">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-slate-800">Verifikasi Keterlambatan</h1>
          <p className="text-slate-500 text-sm">Sidang santri yang terlambat kembali.</p>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-16 bg-white rounded-xl border border-dashed">
          ...
          <h3 className="text-lg font-bold text-slate-700">Semua Tertib!</h3>
          <p className="text-slate-500">Tidak ada antrian sidang keterlambatan saat ini.</p>
        </div>
      ) : (
              ...
              <div key={item.izin_id} className="bg-white p-5 rounded-xl border shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-6 animate-in slide-in-from-bottom-2">
                ...
                <div className="flex gap-4 flex-1">
                  ...
                  <div>
                    ...
                    <div className="flex gap-2 mb-2">
                        <p className="text-xs text-slate-500 bg-slate-50 inline-block px-2 py-0.5 rounded border">
                        {item.info}
                        </p>
                        {item.tgl_kembali ? (
                    ...
                    <div className="text-sm space-y-1">
                      ...
                      <p className="text-xs text-slate-400 italic">"{item.alasan}"</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-2 min-w-[200px]">
                  {processingId === item.izin_id ? (
                    <div className="text-center text-sm text-slate-400 py-4 flex items-center justify-center gap-2">
                    ...
                    <>
                      <button 
                        ...
                        className="w-full py-2.5 px-4 rounded-lg bg-red-600 text-white font-bold text-sm hover:bg-red-700 shadow-sm transition-colors flex items-center justify-center gap-2"
                      >
                      ...
                      <button 
                        ...
                        className="py-2 px-3 rounded-lg border border-slate-300 bg-slate-50 text-slate-600 text-xs font-bold hover:bg-black hover:text-white transition-colors"
                      >
                        TIDAK HADIR SIDANG
                      </button>
                    </>
