...
import { Button, NativeSelect, SegmentedControl } from '@mantine/core'
...
function BarisTelat({ item, no, onVonis }: {
  ...
  const tombol = busy ? (
    ...
    <div className="flex flex-wrap gap-1.5">
      <Button size="xs" color="pink" onClick={() => handle('TELAT_MURNI')}>Telat</Button>
      <Button size="xs" color="yellow" variant="light" onClick={() => handle('SAKIT')}>Sakit</Button>
      <Button size="xs" color="blue" variant="light" onClick={() => handle('IZIN_UZUR')}>Izin</Button>
      <Button size="xs" color="gray" variant="light" onClick={() => handle('MANGKIR')}>Mangkir</Button>
    </div>
  )
            ...
            <div className="flex flex-wrap items-center gap-2.5">
              ...
              {asramaList.length > 1 && (
                <NativeSelect
                  size="xs"
                  value={filterAsrama}
                  onChange={e => { setFilterAsrama(e.target.value); setPage(1) }}
              ...
              <SegmentedControl
                ...
                data={[
                  ...
                  { label: 'Belum Kembali', value: 'OVERDUE' },
                ]}
              />
            </div>
          </div>
