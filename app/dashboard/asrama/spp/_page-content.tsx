        ...
        <div className="flex items-center justify-between bg-white p-2 rounded-xl shadow-sm border">
          ...
          <div className="flex flex-col items-center">
            ...
            <select value={kamarIdx} onChange={e => setKamarIdx(Number(e.target.value))}
              className="font-bold text-lg text-gray-800 text-center outline-none bg-transparent cursor-pointer">
      ...
      {loadingKamar ? (
        ...
        <div className="bg-white border rounded-xl shadow-sm overflow-hidden">
          <div className="bg-gray-50 px-4 py-3 border-b font-bold text-gray-700 text-sm flex justify-between items-center">
            ...
            <span className="text-xs bg-white border px-2 py-1 rounded font-normal text-gray-500">{filteredSantri.length} Santri</span>
          </div>
                    ...
                    {isCurrentYear && !isPaid ? (
                      <button onClick={(e) => toggleDraft(e, s)}
                        className={`px-3 py-1.5 rounded-lg text-xs font-bold border flex items-center gap-1 transition-all ${
                          isDraft ? 'bg-emerald-600 text-white border-emerald-600 shadow-md' : 'bg-white text-gray-500 hover:border-emerald-500 hover:text-emerald-600'
                        }`}>
